...
No portal do curso, clique em AWS Details e copie os valores de:
...
Crie o arquivo de credenciais no seu computador:

mkdir -p ~/.aws
nano ~/.aws/credentials
Cole o conteúdo abaixo, substituindo pelas suas chaves:

[default]
aws_access_key_id = SUA_ACCESS_KEY
aws_secret_access_key = SUA_SECRET_KEY
aws_session_token = SEU_SESSION_TOKEN
Salve com Ctrl+O, Enter, depois saia com Ctrl+X.


Como gerar o JAR
No terminal, vá até a pasta do projeto onde está o arquivo pom.xml. Exemplo:

cd ~/Downloads/JAR_Test/jar-s3
Execute o comando de empacotamento:

mvn clean package
O Maven vai compilar o código, baixar as dependências e gerar o JAR.
Se tudo der certo, a mensagem final será BUILD SUCCESS.
